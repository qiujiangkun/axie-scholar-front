...
const unclaimedIcon = () => (
  <svg width="21" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      ...
      fill="#FF8B00"
    />
    <path d="M6.1084 6.60938L16.0543 16.5553" stroke="#FF8B00" strokeWidth="1.72973" strokeLinecap="round" />
  </svg>
);
...
function Notavailable() {
  return (
    <Wrapper color="#FF8B00">
      <CustomIcon className="text-warning font-size-xl" svg={unclaimedIcon} />
...
function Claimable() {
  return (
    <Wrapper color="#1acb18">
      <CustomIcon className="text-success font-size-xl" svg={checkedIcon} />
      <Text>Claimable</Text>
    </Wrapper>
  );
}
...
export { Claimed, Notavailable, Pending, Claimable, Failed, Error };
